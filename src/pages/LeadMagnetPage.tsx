...
.btn{display:inline-flex;align-items:center;gap:6px;background:var(--g);color:#fff;font-weight:600;padding:15px 32px;border-radius:999px;border:none;cursor:pointer;box-shadow:inset 0 1px 0 rgba(255,255,255,.18),0 1px 2px rgba(0,0,0,.45);transition:filter .15s ease,box-shadow .15s ease;text-decoration:none;font-size:16px;letter-spacing:-.005em}.btn:hover{filter:brightness(1.06);box-shadow:inset 0 1px 0 rgba(255,255,255,.22),0 1px 2px rgba(0,0,0,.45),0 4px 12px rgba(0,0,0,.3)}
...
.hero h1{font-size:clamp(36px,4.2vw,62px);font-weight:800;line-height:1.06;letter-spacing:-.025em;margin-bottom:20px}
...
.hero-sn{font-size:clamp(26px,3vw,38px);font-weight:700;letter-spacing:-.022em;font-variant-numeric:tabular-nums}
...
.h2{font-size:clamp(28px,4vw,48px);font-weight:700;line-height:1.08;letter-spacing:-.025em}
...
/* Form */
.fc{max-width:520px;margin:0 auto;background:var(--card);border:1px solid rgba(255,255,255,.08);border-radius:20px;padding:clamp(28px,4vw,48px);position:relative;backdrop-filter:blur(20px);box-shadow:0 1px 2px rgba(0,0,0,.4),0 8px 32px rgba(0,0,0,.28)}
...
`}</style>
      ...
      <div className="mx hero-g" style={{position:'relative',zIndex:1}}>
        <div>
          ...
          <div className="hero-stats">
            {[{n:'1000+',l:'Owners Helped'},{n:'55%',l:'Revenue Increase'},{n:'#1',l:'NZ Best Workplace'}].map((s,i)=><div key={i}><div className="P G hero-sn">{s.n}</div><div className="hero-sl">{s.l}</div></div>)}
          </div>
          ...
          <div className="hero-trust-mobile">
            {[
              ...
              {icon:<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#f59e0b" strokeWidth="2"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>,text:'141 Five-Star Reviews'},
        ...
        <div className="hero-photo">
          ...
          <div className="hero-trust">
            {[
              {icon:<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 00-3-3.87"/><path d="M16 3.13a4 4 0 010 7.75"/></svg>,text:'1000+ Owners Helped'},
              {icon:<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="12" r="10"/><path d="M12 6v6l4 2"/></svg>,text:'$150M+ Revenue'},
          ...
          <div className="hero-reviews">
            <div className="hero-reviews-num">141</div>
    ...
    <section className="sec" id="proof" style={{background:'var(--bg)'}} ref={s1.ref}>
      <div className="mx">
        ...
        <p style={{textAlign:'center',marginTop:24,fontSize:20,fontWeight:700,background:'var(--g)',WebkitBackgroundClip:'text',WebkitTextFillColor:'transparent',letterSpacing:'.02em'}}>1000+ more success stories like these.</p>
        ...
        <div className={`rv ${s3.v?'vi':''}`} style={{marginBottom:40}}>
          <div style={{display:'flex',alignItems:'center',gap:20,flexWrap:'wrap',marginBottom:8}}>
            ...
            <div style={{display:'flex',alignItems:'center',gap:8}}>
              ...
              <span className="rev-count">(141)</span>
            </div>
          </div>
      ...
      <div className="mx">
        <div className={`bg2 rv ${s4.v?'vi':''}`} style={{display:'grid',gridTemplateColumns:'1fr 1.2fr',gap:'clamp(40px,6vw,80px)',alignItems:'center'}}>
          ...
          <div>
            ...
            <p style={{fontSize:15,color:'var(--dim)',lineHeight:1.7,marginBottom:24}}>Built Premier Group NZ  - 200 tonnes/day, 75 staff. Won NZ's Best Workplace. In a factory. AME Global Lean recognition. 98% employee engagement. 1000+ business owners helped.</p>
            <div style={{display:'flex',gap:12,flexWrap:'wrap',marginBottom:24}}>
              {['AME Lean Tours','Best Workplace #1','98% Engagement','1000+ Owners'].map((c,i)=><span key={i} style={{fontSize:12,fontWeight:600,color:'var(--dim)',background:'var(--card)',border:'1px solid rgba(139,83,236,.25)',borderRadius:999,padding:'6px 14px'}}>{c}</span>)}
            </div>
            <button className="btn btn-lg" onClick={go}>Get My Free Profit Roadmap →</button>
          </div>
        </div>
    ...
    <section style={{background:'var(--lt)',padding:'32px 0'}}>
      <div className="mq"><div className="mq-c">
        {[...Array(2)].map((_,r)=><span key={r}>
          {[
            {icon:<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#8b53ec" strokeWidth="2.5"><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 00-3-3.87"/><path d="M16 3.13a4 4 0 010 7.75"/></svg>,text:'1000+ Kiwi Business Owners'},
            ...
            {icon:<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#f59e0b" strokeWidth="2.5"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>,text:'141 Five-Star Reviews'},
    ...
    <section className="sec" style={{background:'var(--bg)',textAlign:'center',position:'relative',overflow:'hidden'}} ref={s7.ref}>
      ...
      <div className="mx" style={{position:'relative',zIndex:1}}>
        <div className={`rv ${s7.v?'vi':''}`}>
          ...
          <button className="btn btn-lg" onClick={go}>Get My Free Profit Roadmap →</button>
          <p style={{marginTop:20,fontSize:12,color:'var(--mut)'}}>1000+ NZ business owners · 141 five-star reviews · AME Lean Recognition</p>
        </div>
      </div>
    </section>
