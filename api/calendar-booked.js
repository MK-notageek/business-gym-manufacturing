// Triggered from ThankYouPage when GHL's calendar widget posts
// ['msgsndr-booking-complete', payload] as an Array postMessage.
// Adds the `call-booked` tag (preserving existing tags) and posts a note.
...
export default async function handler(req, res) {
  ...
  // GET existing tags, merge with `call-booked`, PUT the union back.
  try {
